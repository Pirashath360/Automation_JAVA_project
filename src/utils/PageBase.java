...
public class PageBase {
    ...
    protected static String uploadFilepath = System.getProperty("user.dir")+File.separator+"automation"+ File.separator+"drivers"+File.separator+"fileUpload";
    private static String osType=System.getProperty("os.Type",Constants.WINDOWS);
    public static String driverType=System.getProperty("browser.type",Constants.CHROME);
